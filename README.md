...
### NOTE: The master branch implements SVclone's [biorXiv version](https://www.biorxiv.org/content/10.1101/172486v1.abstract). SVclone now uses [ccube's](https://www.biorxiv.org/content/10.1101/484402v1.abstract) clustering model. We recommend running this version. Please switch the the 'ccube' branch and follow the run and install instructions ###
