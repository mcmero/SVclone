...
### NOTE: The master branch now implements clustering using the [ccube](https://www.biorxiv.org/content/10.1101/484402v1.abstract) clustering model. If you would like to run the PyMC2 clustering model (described in the [biorXiv version](https://www.biorxiv.org/content/10.1101/172486v1.abstract), please use the `pymc2` branch). SVclone now uses [ccube's](https://www.biorxiv.org/content/10.1101/484402v1.abstract) clustering model, although we highly recommend running the ccube version. ###
